...
public class FixationCrossTuning : Environments
{
    ...
    private void Update()
    {
        ...
        if (tuningController.currentEyeTrackingScript.lookingAtSearchObject)
        {
            // eyeTracking
    ...
    {
        tuningController.fadeController.FadeOutNoDelay();
        tuningController.ResumeScene();
    }
}
