...
public class TuningEnvironment : Environments
{
    ...
    {
        // fixed obj to assist
        SpawnObject(simpleObjectPrefab, new Vector3(2.5f, 2f, 3f));
        SpawnObject(simpleObjectPrefab, new Vector3(-2.5f, 2f, 3f));
        SpawnObject(simpleObjectPrefab, new Vector3(0, 4.5f, 3f));
        SpawnObject(simpleObjectPrefab, new Vector3(2f, 4f, 3f));
        SpawnObject(simpleObjectPrefab, new Vector3(-2f, 4f, 3f));
        // searched object (center of ripple effect)
