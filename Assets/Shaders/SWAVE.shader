    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct v2f
            {
                ...
                float3 localRippleCenter : TEXCOORD1;
            };
            ...
            v2f vert(appdata v)
            {
                ...
                float3 localCenter = mul(unity_WorldToObject, float4(_WorldRippleCenter.xyz, 1.0)).xyz;
                o.localRippleCenter = localCenter;
            ...
            {
                float dist = distance(i.localPos, i.localRippleCenter);
